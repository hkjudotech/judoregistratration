...
$stmt->bind_param("sss", $date, $type1, $type2);
$type1 = "local";
$type2 = "check"; 
$stmt->execute();
...
<div class = "row row-block">
	...
	<h3>比賽 Upcoming Competition</a></h3>
...
<div class = "row-content col-xs-12 col-md-5"><?php echo $comp['name']?><br><? echo $comp['name_eng']?></div>
