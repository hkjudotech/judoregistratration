...
$mailfee=60;
 ...
 //Select data from participants
    $stmt = $pdo->prepare('SELECT id, name, name_chi, birthday, gender, category, active_member 
...
echo "temp = new Array();";
 ...
 while ($play3 = $stmt->fetch()) {
        ...
        echo "temp[".$i."][4] = '".htmlspecialchars($play3['category'])."';";
...
<div class="row row-block">
	...
	<form name="myForm" method="POST" action="<?php echo $_SERVER['PHP_SELF'];?>">
		...
		<div class = "row mt2">
			...
			<div class = "col-md-2">重新註冊級別<br>Renewal Grade</div>
			...
			echo 	'</select>
				...
				<div class = "col-md-2">
					...
					<select name=level'.$f.' onchange="calculate'.$f.'();" style="font-family: Arial" size="1">
						...
						<option value = "A">課程 + A級教練</option>

						<option value = "B">課程 + B級教練</option>

						<option value = "C">課程 + C級教練</option>
		...
		<div class = "row">
			...
			<div class = "col-md-8 text-center"> 
				...
				<div class = "row">
					...
					<div class = "col-md-6 border-full">教練註冊年費 - A級(只適用於重新註冊者)</div>
        		...
        		<div class = "row">
					...
					<div class = "col-md-6 border-full">教練註冊年費 - B級(只適用於重新註冊者)</div>
            	...
            	<div class = "row">
					...
					<div class = "col-md-6 border-full">教練註冊年費 - C級(只適用於重新註冊者)</div>
